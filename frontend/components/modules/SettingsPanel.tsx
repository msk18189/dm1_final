      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="rounded-2xl border border-border bg-surface p-5 space-y-4 shadow-sm flex flex-col justify-between">
          <div className="space-y-4">
            <div className="flex items-center gap-3">
              <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-violet-50/50 dark:bg-violet-950/20 border border-violet-100/15 dark:border-violet-900/20 text-violet-600 dark:text-violet-400 shrink-0">
                <Sparkles className="h-4 w-4" />
              </div>
              <div>
                <h3 className="text-sm font-bold text-primary">AI Analytics Settings</h3>
                <p className="text-[10px] text-muted font-semibold">Configure intelligence models and reporting</p>
              </div>
            </div>
